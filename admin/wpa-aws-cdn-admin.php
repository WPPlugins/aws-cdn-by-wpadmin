...
<b> Minimum Cache Time in seconds:</b><br>

<input type=number min=600 max=3600 step=600  id=wpaac_cdnminttl class=form-control placeholder="Minimum TTL" value="<?php echo $cdnminttl ; ?>">

</p>

<p>
<b> Maximum Cache Time  in seconds:</b><br>
<input type=number min=1800 max=86400  step=600 id=wpaac_cdnmaxttl class=form-control placeholder="Maximum TTL" value="<?php echo $cdnmaxttl ; ?>">
								...
								<div class="tab-pane" id="tab2">
									...
									<p>
										...
										<dl>
											...
											<dd>The plugin replaces the domain name on all static assets (images, scripts, stylesheets,etc) in the wp-content folder.</dd>
											...
											<dd>Thanks! I accept your kindness via <a href='https://PayPal.Me/GraySquareSolutions' target=_BLANK>PayPal</a></dd>
